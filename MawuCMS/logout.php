...
<section>
	...
	<div class="text-center"> 
		...
		<p class="text-muted mb-0">Esperamos ver você de volta em breve!</p>
		<hr>
		<p class="text-muted mb-0">Em instantes te tiraremos daqui...</p>
		<p class="text-muted mb-0"><a href="<?php echo $Holo['url']; ?>/"><button class="btn btn-danger mt-4">Sair agora</button></a></p>
	</div>
